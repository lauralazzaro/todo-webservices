 ...
 */
final class Version20230811193504 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(60) NOT NULL, email VARCHAR(60) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
