 ...
 */
final class Version20240130091455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL, is_password_generated BOOLEAN NOT NULL, generated_password_validity DATETIME NOT NULL --(DC2Type:datetime_immutable)
